...
public class Main {
    public static void main(String args[]) {
        String arr[] = {"browser_history", "visit", "visit", "back","visit","visit","back"};
        String arr1[][] = {{"leetcode.com"}, {"google.com"}, {"1"},{"facebook.com"},{"bookmyshow.com"},{"1"}};
        ...
        for (int i = 0; i < arr.length; i++) {
            if (arr[i].equals("browser_history")) {
              ...
              int num = Integer.parseInt(arr1[i - 1][0]);
               ...
               System.out.println("Back "+num+ " to "+arr2[i-num-1]);
              arr2[i - num-1]=null;
            } else {
